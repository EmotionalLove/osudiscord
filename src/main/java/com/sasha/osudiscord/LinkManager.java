...
public class LinkManager {
    ...
    public static String name = "LinkedOsuAccounts.yml";

    public static File getTheYml() throws IOException {
    ...
    public static void link(String discordid, String osuname) throws IOException {
        YML yml = new YML(getTheYml());
        yml.set("user_" + discordid, osuname);
        yml.save();
    }
